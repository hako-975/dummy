...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Jun 2022 pada 08.36
...
--
-- Database: `akademik_andri_04tplp016`
--
CREATE DATABASE IF NOT EXISTS `akademik_andri_04tplp016` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `akademik_andri_04tplp016`;
...
('201011402110', 'Rizky Febriansyah', 'Pondok Aren'),
('201011402115', 'Dzaki Rozzan', 'Alam Sutra'),
('201011402124', 'Fiki Aji', 'Buaran'),
('201011402125', 'Andri Firman Saputra', 'Jl. Pocis'),
('201011402142', 'Yaasmiin Asa Nuha Putri', 'Tangerang');
...
('04001', 'Basis Data', 18),
('04002', 'Pemrograman 1', 18),
('04003', 'Bahasa Inggris', 14),
('04004', 'Statistik Lanjut', 14),
('04005', 'Praktikum Struktur Data', 14);
...
(1060, 'Pengguna irgi12 berhasil login', '2021-12-17 23:31:25', 3),
(1061, 'Pengguna irgi12 berhasil logout', '2021-12-17 23:32:47', 3),
(1062, 'Pengguna super_administrator berhasil login', '2021-12-17 23:32:55', 1),
(1063, 'Pengguna super_administrator berhasil logout', '2021-12-17 23:35:04', 1),
(1064, 'Pengguna andre975 berhasil login', '2022-05-13 22:48:23', 2),
(1065, 'Transaksi 13052022123T0001 berhasil ditambahkan', '2022-05-13 23:30:05', 2),
(1066, 'Detail Transaksi 13052022123T0001 berhasil ditambahkan', '2022-05-13 23:30:30', 2),
(1067, 'Transaksi  berhasil diubah status transaksinya', '2022-05-13 23:32:49', 2),
(1068, 'Pembayaran Transaksi 13052022123T0001 berhasil', '2022-05-13 23:33:16', 2),
(1069, 'Cetak Invoice - 13052022123T0001 - Bintang Shakila Akassah', '2022-05-13 23:33:29', 2),
(1070, 'Pengguna andre975 berhasil logout', '2022-05-13 23:42:58', 2);
...
(46, '13052022123T0001', '2022-05-13 23:30:04', '2022-05-13 23:29:00', '2022-05-13 23:33:16', 0, 0, 10, 'dicuci', 'sudah dibayar', 3, 1, 2);
...
--
ALTER TABLE `detail_transaksi`
  MODIFY `id_detail_transaksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
ALTER TABLE `log`
  MODIFY `id_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1071;
...
('9780140256345', 'Senja, Hujan dan Cerita Yang Telah Usai', 2015, 20, 1, 5, 3),
...
--
DELIMITER $$
CREATE TRIGGER `data_awal_jumlah_buku_andri` BEFORE UPDATE ON `buku` FOR EACH ROW begin insert into revisi_buku_andri
set kode_buku = old.kode_buku,
jumlah_buku_lama = old.jumlah_buku,
jumlah_buku_baru = new.jumlah_buku,
waktu_update = now();
end
$$
DELIMITER ;
...
CREATE TABLE `donatur` (
  ...
  `no_telepon_donatur` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `donatur` (`id_donatur`, `nama_donatur`, `alamat_donatur`, `no_telepon_donatur`) VALUES
...
INSERT INTO `pinjam` (`id_pinjam`, `tanggal_pinjam`, `tanggal_pengembalian`, `nik_peminjam`, `kode_buku`, `id_user`) VALUES
(1, '2022-03-22 10:03:23', '2022-03-24 10:00:00', '3674072901021001', '9780140256352', 1),
(2, '2022-03-22 10:03:23', '2022-03-24 10:00:00', '3671015906010005', '9781338732870', 1);
...
--
-- Struktur dari tabel `revisi_buku_andri`
--

CREATE TABLE `revisi_buku_andri` (
  `id_revisi_buku` int(11) NOT NULL,
  `kode_buku` varchar(20) NOT NULL,
  `jumlah_buku_lama` int(11) NOT NULL,
  `jumlah_buku_baru` int(11) NOT NULL,
  `waktu_update` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `revisi_buku_andri`
--

INSERT INTO `revisi_buku_andri` (`id_revisi_buku`, `kode_buku`, `jumlah_buku_lama`, `jumlah_buku_baru`, `waktu_update`) VALUES
(1, '9780140256345', 69, 25, '2022-06-13 12:12:04'),
(2, '9780140256345', 25, 20, '2022-06-13 12:12:30');
...
--
-- Indeks untuk tabel `revisi_buku_andri`
--
ALTER TABLE `revisi_buku_andri`
  ADD PRIMARY KEY (`id_revisi_buku`),
...
--
-- AUTO_INCREMENT untuk tabel `revisi_buku_andri`
--
ALTER TABLE `revisi_buku_andri`
  MODIFY `id_revisi_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
('root', '[{\"db\":\"perpustakaan_andri\",\"table\":\"revisi_buku_andri\"},{\"db\":\"perpustakaan_andri\",\"table\":\"penambahan_buku\"},{\"db\":\"perpustakaan_andri\",\"table\":\"buku\"},{\"db\":\"perpustakaan_andri\",\"table\":\"donatur\"},{\"db\":\"perpustakaan_andri\",\"table\":\"peminjam\"},{\"db\":\"perpustakaan_andri\",\"table\":\"penerbit\"},{\"db\":\"perpustakaan_andri\",\"table\":\"pengarang\"},{\"db\":\"perpustakaan_andri\",\"table\":\"pinjam\"},{\"db\":\"perpustakaan_andri\",\"table\":\"pembelian\"}]');
...
('root', '2022-06-13 06:36:25', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"id\"}');
...
ALTER TABLE `user`
  MODIFY `id_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- Database: `ujian1_penjualanhp_andri`
--
CREATE DATABASE IF NOT EXISTS `ujian1_penjualanhp_andri` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ujian1_penjualanhp_andri`;
...
CREATE TABLE `hp` (
  ...
  `merk_hp` varchar(25) NOT NULL,
  `spesifikasi_hp` text NOT NULL,
...
(1, 'Andri Firman', '087808675313', 'Jl. AMD Babakan Pocis'),
(2, 'Fiji Aji', '083812121212', 'Gg. Buaran'),
(3, 'Azriel', '087842434242', 'Bintaro');
...
INSERT INTO `transaksi` (`id_transaksi`, `id_hp`, `tanggal_transaksi`, `jam_transaksi`, `kuantitas`, `total_pembayaran`, `id_pelanggan`, `id_user`) VALUES
(1, 1, '2022-04-11', '10:16:16', 1, 1000000, 3, 3),
(2, 2, '2022-04-12', '16:30:17', 1, 11000000, 2, 2),
(3, 1, '2022-04-13', '17:09:00', 2, 2800000, 1, 1);
...
INSERT INTO `user` (`id_user`, `username`, `password`, `nama_lengkap`) VALUES
(1, 'admin', 'admin', 'Admin'),
(2, 'yas123', 'admin123', 'Yaasmiin'),
(3, 'iggy987', 'iggy', 'Iggy Gong');
...
ALTER TABLE `transaksi`
  ...
  ADD CONSTRAINT `transaksi_ibfk_2` FOREIGN KEY (`id_hp`) REFERENCES `hp` (`id_hp`) ON DELETE CASCADE ON UPDATE CASCADE,
...
(6, 'Andri Firman Saputra', 'andrifirman123', '$2y$10$PKnPQ1GzwXi6k9zn6j4mVuGu8B2NdCEshQ6QH3vdm/iRV36i7apS6', '087808675313', 'Jl. AMD Babakan Pocis No. 100 RT04/02, Kel. Bakti Jaya, Kec. Setu, Kota Tangerang Selatan, Prov. Banten, 15315');
...
(5, 'Sekolah Longsor', '2022-05-13 22:26:34', 'longsoran.jpg', 'belum_ditanggapi', 6, 53);
