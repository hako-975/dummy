...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Jul 2022 pada 18.38
...
('root', '[{\"db\":\"uas_andri_spbu\",\"table\":\"karyawan\"},{\"db\":\"uas_andri_spbu\",\"table\":\"kendaraan\"},{\"db\":\"uas_andri_spbu\",\"table\":\"transaksi_pengisian\"},{\"db\":\"perpustakaan_andri\",\"table\":\"pinjam\"},{\"db\":\"perpustakaan_andri\",\"table\":\"buku\"},{\"db\":\"perpustakaan_andri\",\"table\":\"peminjam\"},{\"db\":\"perpustakaan_andri\",\"table\":\"revisi_pinjam_andri\"},{\"db\":\"perpustakaan_andri\",\"table\":\"revisi_buku_andri\"},{\"db\":\"perpustakaan_andri\",\"table\":\"penerbit\"},{\"db\":\"perpustakaan_andri\",\"table\":\"donatur\"}]');
...
('root', '2022-07-09 16:38:41', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"id\",\"NavigationWidth\":257}');
...
ALTER TABLE `user`
  MODIFY `id_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- Database: `uas_andri_spbu`
--
CREATE DATABASE IF NOT EXISTS `uas_andri_spbu` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `uas_andri_spbu`;
...
INSERT INTO `karyawan` (`id_karyawan`, `nama_karyawan`, `no_telp_karyawan`, `alamat_karyawan`) VALUES
(1, 'Ratih Hastuti', '087713583877', 'Jl. Orang No. 15'),
(2, 'Cayadi Maulana', '08591183442', 'Jl. Pocis No. 69'),
(3, 'Artanto Januar', '089864019263', 'Gg. Lembok No. 8');
...
CREATE TABLE `kendaraan` (
  ...
  `harga_per_liter` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `kendaraan` (`id_kendaraan`, `tipe_kendaraan`, `jenis_bahan_bakar`, `harga_per_liter`) VALUES
(1, 'Mobil Sport', 'Pertamax Racing', 50000),
(2, 'Mobil SUV', 'Dexlite', 18000),
(3, 'Mobil MPV', 'Pertamax Plus', 15000),
(4, 'Motor Bebek', 'Pertamax', 12000),
(5, 'Motor Matic', 'Pertalite', 10000),
(6, 'Truk', 'Bio Diesel', 20000);

-- --------------------------------------------------------

--
-- Struktur dari tabel `transaksi_pengisian`
--

CREATE TABLE `transaksi_pengisian` (
  `id_transaksi` int(11) NOT NULL,
  `id_kendaraan` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `transaksi_pengisian`
--

INSERT INTO `transaksi_pengisian` (`id_transaksi`, `id_kendaraan`, `harga_beli`, `id_karyawan`) VALUES
(1, 1, 500000, 1),
(2, 2, 100000, 2),
(3, 3, 120000, 2),
(4, 4, 20000, 3),
...
--
-- Indeks untuk tabel `transaksi_pengisian`
--
ALTER TABLE `transaksi_pengisian`
  ADD PRIMARY KEY (`id_transaksi`),
...
--
-- AUTO_INCREMENT untuk tabel `transaksi_pengisian`
--
ALTER TABLE `transaksi_pengisian`
